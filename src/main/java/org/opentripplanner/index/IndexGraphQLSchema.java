    ...
    public IndexGraphQLSchema(GraphIndex index) {
        ...
        GraphQLFieldDefinition planFieldType = GraphQLFieldDefinition.newFieldDefinition()
            ...
            .argument(GraphQLArgument.newArgument()
                    ...
                    .build())            
            .argument(GraphQLArgument.newArgument()
                .name("airQualityPenaltyThresholdLow")
                .description("Threshold when the low air quality penalty starts to affect routing")
                .type(Scalars.GraphQLFloat)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("airQualityPenaltyThresholdHigh")
                .description("Threshold when the high air quality penalty starts to affect routing")
                .type(Scalars.GraphQLFloat)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("airQualityPenaltyLowRate")
                .description("Low air quality penalty rate")
                .type(Scalars.GraphQLFloat)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("airQualityPenaltyHighRate")
                .description("High air quality penalty rate")
                .type(Scalars.GraphQLFloat)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("airQualityMode")
                .description("A air quality routing mode. Either TIME or DISTANCE. Defaults to TIME")
                .type(Scalars.GraphQLString)
                .build())
            .argument(GraphQLArgument.newArgument()
                .name("walkReluctance")
    ...
    private void createPlanType(GraphIndex index) {
        ...
        final GraphQLObjectType itineraryType = GraphQLObjectType.newObject()
            ...
            .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .description("How much user has exposed to pollution.")
                .type(Scalars.GraphQLFloat)
                .dataFetcher(environment -> ((Itinerary)environment.getSource()).pollutionExposure)
                .build())
            .field(GraphQLFieldDefinition.newFieldDefinition()
                .name("legs")
